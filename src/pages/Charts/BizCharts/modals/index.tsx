...
import { Lines, Columns, Pies, Bars, Radars, Words } from '@/pages/Charts/BizCharts/components';
...
const BizChartsModals: React.FC<AntdChartsProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      {modalType && modalType === 'BasisWordCloud' ? (
        <Words.BasisWordCloud height={modalHeight} />
      ) : null}
    </Modal>
  );
};

export default BizChartsModals;
